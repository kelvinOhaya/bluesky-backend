...
const api = axios.create({
    baseURL: import.meta.env.VITE_L_BACKEND_URL,
...
export const injectAuthToken = (getToken, setAccessToken) => {
    api.interceptors.request.use((config) => {//request for the object that will be sent out
    ...
    api.interceptors.response.use(res => res,
        async (error) => {//get the error object
